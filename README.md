...
- `java -jar users-api-gateway/build/libs/users-api-gateway-0.0.1-SNAPSHOT.jar`
- `java -jar users-command/build/libs/users-command-0.0.1-SNAPSHOT.jar`
- `java -jar users-query/build/libs/users-query-0.0.1-SNAPSHOT.jar`
