...
- `java -jar users-api/build/libs/users-api-gateway-0.0.1-SNAPSHOT.jar`
- `java -jar users-cud/build/libs/users-command-0.0.1-SNAPSHOT.jar`
- `java -jar users-read/build/libs/users-query-0.0.1-SNAPSHOT.jar`
